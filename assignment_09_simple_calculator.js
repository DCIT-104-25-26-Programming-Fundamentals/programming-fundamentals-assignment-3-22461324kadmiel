...
function main() {
    while (true) {
        ...
        if (choice === 1) { result = add(a, b); symbol = '+'; }
        else if (choice === 2) { result = subtract(a, b); symbol = '-'; }
        else if (choice === 3) { result = multiply(a, b); symbol = '*'; }
        else if (choice === 4) {
            result = divide(a, b);
            symbol = '/';
            if (result === null) {
        ...
        else if (choice === 5) { result = modulus(a, b); symbol = '%'; }
        else if (choice === 6) { result = power(a, b); symbol = '**'; }
